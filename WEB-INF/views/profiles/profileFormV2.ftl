    ...
    <table name="BodyBackground" align="center" cellspacing="5" cellpadding="5" border="0" bgcolor="#CCCCCC" ><tr ><td >
                ...
                <table align="center" cellspacing="10" cellpadding="2" border="0" bgcolor="#6A639D" ><tr><td bgcolor="#FFFFFF" >
                            <table align="center" cellspacing="2" cellpadding="2" border="0" bgcolor="#FFFFFF" ><tr><td bgcolor="#FFFFFF" >
                                        <table align="center" cellspacing="2" cellpadding="2" border="0" bgcolor="#FFFFFF" ><tr><td bgcolor="#FFFFFF" >
                                                    <@s.form method="POST" enctype="multipart/form-data" novalidate="novalidate">
                                                    <@s.hidden name="id"/>
...
<#--                                                    <input type="hidden" name="businessType" value="${businessType?if_exists}"/>-->
                                                    ...
                                                    <@s.textfield id="clientType" cssStyle="display:none;" label="Client Type" value="${clientType}" readonly="true"  />
                                                    <#--<@s.textfield label="Type of Business Entity" value="%{businessType}" readonly="true"  />-->
                                                    <@s.select id= "businessEntityType" cssStyle="display:none;" label="Type of Business Entity" name="businessType" list="%{businessTypeList}" listKey="code" listValue="name"/>
                                                    <#--		  <@s.textfield label="Nature of Business" value="%{natureOfBusiness}" readonly="true"  />-->
                                                    <@s.select id="businessNature" cssStyle="display:none;" label="Nature of Business" name="natureOfBusiness" list="%{naturesOfBusiness}" listKey="code" listValue="%{(name.length() > 40 ? name.substring(0,40) + '...' : name) + ' (' + code + ')'}" cssStyle="width: 279.33px;"/>
                                                    <@s.textfield id="insClientNo" cssStyle="display:none;" label="INS Client Number" name="profile.insClientNo" readonly="true"  />
                                                    <!--<@s.textfield label="INS Client Number" value="%{profile.insClientNo}" readonly="true"  />-->
                                                    <@s.textfield id="companyName" cssStyle="display:none;" label="Business Name/Company Name" name="profile.company" maxLength=35/>
                                                    <@s.textfield id="firstName" cssStyle="display:none;" label="First Name" name="profile.firstName" maxLength=35/>
                                                    <@s.textfield id="middleName" cssStyle="display:none;" label="Middle Name" name="profile.middleName" maxLength=35/>
                                                    <@s.textfield id= "lastName" cssStyle="display:none;" label="Last Name " name="profile.lastName" maxLength=35/>
                                                    <@s.select id="citizenship" cssStyle="display:none;" label="Country of Citizenship" name="profile.citizenship" list="%{countries}" listKey="code" listValue="name"/>
                                                    <@s.textfield id="address" cssStyle="display:none;" label="Address" name="profile.address" maxLength=70/>
                                                    <@s.textfield id="city" cssStyle="display:none;" label="City" name="profile.city" maxLength=25/>
                                                    <@s.textfield id="zipCode" cssStyle="display:none;" label="Zip Code" type="number" name="profile.zipCode" maxlength="9"/>
                                                    <@s.select id="country" cssStyle="display:none;" label="Country" name="profile.country" list="%{countries}" listKey="code" listValue="name"/>
                                                    <@s.textfield id="telNo" cssStyle="display:none;" label="Telephone Number" name="profile.telephone" maxLength=15/>
                                                    <@s.textfield id="altTelNo" cssStyle="display:none;" label="Alternate Telephone Number" name="profile.altTelephone" maxLength=15  />
                                                    <@s.textfield id="fax" cssStyle="display:none;" label="Fax" name="profile.fax" maxLength=15  />
                                                    <@s.textfield id="mobileNo" cssStyle="display:none;" label="Mobile Number" name="profile.mobile" maxLength=15   />
                                                    <@s.textfield id="email" lcssStyle="display:none;" abel="Email Address" name="profile.email" maxLength=88/>
                                                    <@s.textfield id="website" cssStyle="display:none;" label="Website" name="profile.website" maxLength=100  />
                                                    <@s.textfield id="bondedWarehouse" cssStyle="display:none;" label="Warehouse Code" name="profile.CustomBondedWarehouse" maxLength=15/> <!--not required-->
                                                    <@s.textfield id="tinNo" cssStyle="display:none;" label="TIN" name="profile.tinNo" minLength=12 maxLength=12/>
                                                    <@s.textfield id="sssNo" cssStyle="display:none;" label="SSS Number" name="profile.sssIdNo" maxLength=17/>
                                                    <@s.textfield id="passportNo" cssStyle="display:none;" label="Passport Number" name="profile.passportIdNo" maxLength=17   />
                                                    <@s.textfield id="driverLicenseNo" cssStyle="display:none;" label="Driver's License" name="profile.driverLicenseIdNo" maxLength=17  />
                                                    <@s.textfield id="prcIdNo" cssStyle="display:none;" label="PRC Id Number" name="profile.prcIdNo" maxLength=17/>
                                                    <@s.textfield id="primaryVASPNo" cssStyle="display:none;" label="VASP Primary CCN" value="VA0000000116" name="profile.vaspPrimaryCcn" maxLength=12 required="true" readonly="true"/>
                                                    <@s.textfield id="secondaryVASPNo" cssStyle="display:none;" label="VASP Secondary CCN" name="profile.vaspSecondaryCcn" maxLength=12/>
                                                    <@s.textfield id="uniqueRefNo" cssStyle="display:none;" label="Unique Reference Number" name="profile.pezaIdNo" maxLength=17/>
                                                    <@s.textfield id="SECRegNo" cssStyle="display:none;" label="SEC Registration Number" name="profile.secIdNo" maxLength=17/>
                                                    <@s.textfield id="authCapitalStockAmount" cssStyle="display:none;" label="Authorized Capital Stock Amount" name="profile.capitalStockAmount" maxLength=18/>
                                                    <@s.textfield id="paidUpCapitalAmount" cssStyle="display:none;" label="Paid Up Capital Amount" name="profile.paidUpCapitalAmount" type="number" maxLength=18/>
                                                    <@s.textfield id="aabAssignedBankRefNo" cssStyle="display:none;" label="AAB Assigned Bank Reference No." name="profile.aabAssignedBankRefNo" readonly="true"   />
                                                    <@s.textfield id="relatedCompany1" cssStyle="display:none;" label="Related Company" name="profile.relatedCompanyName1"  maxLength=100   />
                                                    <@s.textfield id= "relatedCompany2" cssStyle="display:none;" label="Related Company" name="profile.relatedCompanyName2"  maxLength=100   />
                                                    <@s.textfield id="relatedCompany3" cssStyle="display:none;" label="Related Company" name="profile.relatedCompanyName3"  maxLength=100   />
                                                    <@s.select id="bondedWarehouseType" cssStyle="display:none;" label="Custom Bonded Warehouse Type" name="profile.customBondedWarehouseType" list="%{customBondedWarehouseType}" listKey="code" listValue="name"/>
                                                    <@s.textfield id="certOfAuth" cssStyle="display:none;" label="Certificate of Authority" name="profile.certificateOfAuthority" maxLength=18/>
                                                    <@s.textfield id="underWritingCap" cssStyle="display:none;" label="Under Writing Capacity" name="profile.underWritingCapacity" maxLength=16 />
                                                    <@s.textfield id="primaryBrokerTIN" cssStyle="display:none;" label="Primary Broker TIN" name="profile.priBrokerTaxpayerIdNo" maxLength=12/>
                                                    <@s.textfield id="primaryBrokerCCN" cssStyle="display:none;" label="Primary Broker CCN" name="profile.priBrokerCCN" maxLength=12/>
                                                    <@s.textfield id="secondaryBrokerTIN" cssStyle="display:none;" label="Secondary Broker TIN" name="profile.secBrokerTaxpayerIdNo" maxLength=12  />
                                                    <@s.textfield id="secondaryBrokerCCN" cssStyle="display:none;"  label="Secondary Broker CCN" name="profile.secBrokerCCN" maxLength=12  />
