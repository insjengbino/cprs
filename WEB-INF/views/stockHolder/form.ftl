<html>
	...
	<script>
		window.onload = function () {
			var pictureImage = document.getElementsByName('stockholderPictureFile')[0];
			var signatureImage = document.getElementsByName('stockholderSignatureFile')[0];
			if (pictureImage) {
...
<table width="100%" align="center" cellspacing="2" cellpadding="2" border="0" bgcolor="#FFFFFF" ><tr><td bgcolor="#FFFFFF" >
	...
	<tbody>
		...
		<@s.textfield label="Zip Code" name="majorStockholder.zipCode" maxLength=4 required="true" />
