...
<table width="100%" align="center" cellspacing="2" cellpadding="2" border="0" bgcolor="#FFFFFF" ><tr><td bgcolor="#FFFFFF" >
		...
		<table border="2" width="100%" cellspacing="0" cellpadding="0" align=center rules=rows frame=box>
			...
			<tbody>
			<@s.iterator value="importers">
				<@s.url id="editURL" action="editImporter">
					<@s.param name="id" value="id"/>
				</@s.url>			
				<@s.url id="deleteURL" action="deleteImporter">
					<@s.param name="id" value="id"/>
				</@s.url>
				<tr>
	...
	<tr><td align=center>
	<@s.url id="addImporter" action="addImporter"/>		
	<button onClick="window.location='${addImporter}'">Add</button>		
