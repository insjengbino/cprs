...
<table width="100%" align="center" cellspacing="2" cellpadding="2" border="0" bgcolor="#FFFFFF" ><tr><td bgcolor="#FFFFFF" >
		...
		<table border="2" width="100%" cellspacing="0" cellpadding="0" align=center rules=rows frame=box>
			...
			<tbody>
			<@s.iterator value="stockholders">
				<@s.url id="editURL" action="editStockholder">
					<@s.param name="id" value="id"/>
				</@s.url>			
				<@s.url id="deleteURL" action="deleteStockholder">
					<@s.param name="id" value="id"/>
				</@s.url>
				<tr>
		...
		<tr><td align=center>
		<@s.url id="addStockHolder" action="addStockholder"/>		
		<button onClick="window.location='${addStockHolder}'">Add</button>						
